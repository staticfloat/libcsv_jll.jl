...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libcsv_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("76ce3406-eb3b-58b5-9095-caeac20e920c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libcsv", artifacts_toml) for e in artifacts["libcsv"]]
...
if best_platform === nothing
    @debug("Unable to load libcsv; unsupported platform $(triplet(platform_key_abi()))")
else
